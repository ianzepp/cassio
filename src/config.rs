...
pub struct EmbeddingConfig {
    ...
    #[serde(default)]
    pub auto_index: bool,
    /// Embedding provider: `"builtin"`, `"ollama"`, or an OpenAI-compatible provider.
    pub provider: Option<String>,
    /// Embedding model name passed to the provider.
    pub model: Option<String>,
    /// Provider base URL. Unused for `"builtin"`; otherwise use values such as
    /// Ollama `http://127.0.0.1:11434` or OpenAI-compatible
